  ...
  return (
    <div className="console-fs">
      ...
      <div className="cluster-left">
        <KeyCluster binding={BINDINGS[0]} heldKeys={heldKeys} onPress={engine.press} onRelease={engine.release} />
      </div>
      <div className="cluster-right">
        <KeyCluster binding={BINDINGS[1]} heldKeys={heldKeys} onPress={engine.press} onRelease={engine.release} />
      </div>
    </div>
  );
}
